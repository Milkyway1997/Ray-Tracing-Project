...
public:
	...
	*/
	Cylinder(const dvec3& position = dvec3(0.0, 0.0, -5.0),
		const color& material = color(1.0, 1.0, 1.0, 1.0),
		double radius = 1.0, double length = 10.0);
	...
	*/
	...
	virtual void setXCylinder();
	virtual void setYCylinder();
	virtual void setZCylinder();

	double radius, length;
	dvec3 topCenter, botCenter;
	BOOLEAN isX, isY, isZ;
